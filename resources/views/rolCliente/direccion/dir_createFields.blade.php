...
<div class="row">
  <div class="form-group col-sm btn-sm">
    <label for="telefono_fijo " >{{ __('Teléfono fijo a 10 díjitos') }}</label>
    <div class="input-group">
      <div class="input-group-prepend">
        <span class="input-group-text"><i class="fas fa-tty"></i></span>
      </div>
      <div>
        {!! Form::number('lada_telefono_fijo', null, ['class' => 'form-control disable' . ($errors->has('lada_telefono_fijo') ? ' is-invalid' : ''), 'min' => 1, 'max' => 9999, 'placeholder' => __('Lada'), 'readonly' => 'readonly']) !!}
      </div>
  ...
  <div class="form-group col-sm btn-sm">
    <label for="telefono_movil">{{ __('Teléfono móvil a 10 díjitos') }} </label>
    <div class="input-group">
      <div class="input-group-prepend">
        <span class="input-group-text"><i class="fas fa-mobile-alt"></i></span>
      </div>
        <div>
          {!! Form::number('lada_telefono_movil', null, ['class' => 'form-control disable' . ($errors->has('lada_telefono_movil') ? ' is-invalid' : ''), 'min' => 1, 'max' => 9999, 'placeholder' => __('Lada'), 'readonly' => 'readonly']) !!}
        </div>
  ...
  <div class="form-group col-sm btn-sm">
    ...
    <div class="input-group">
      <div class="input-group-prepend">
        ...
        {!! Form::text('pais', null, ['class' => 'form-control disable' . ($errors->has('pais') ? ' is-invalid' : ''), 'maxlength' => 40, 'placeholder' => __('México'), 'readonly' => 'readonly']) !!}
    </div>
