...
--}}
  <div class="form-group row p-0 m-0">
      ...
      <div class="col-sm-9">
        <div class="input-group-append text-dark"> 
          <select  id="select_products" class="form-control select2" placeholder='Seleccione. . .'>
            ...
            <option value="catalogos">{{ __('Productos de Catálogo') }}</option>
            <option value="productos">{{ __('Productos externos') }}</option>
    ...
    <div class=" form-group col-sm-4">
      ...
      <div class="input-group-append text-dark">
        <select class="form-control select2 " id="resultados" placeholder='Seleccione. . .' name="ids_productos[]"  multiple>
