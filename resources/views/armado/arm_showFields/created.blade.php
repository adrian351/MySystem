<div id="armado">
  <div class="card">
      <h5 class="mb-0 p-1">
        <button class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapseArmado" aria-expanded="false" aria-controls="collapseArmado">
          <i class="fas fa-info-circle"></i>&nbsp;&nbsp;&nbsp;<b>{{ __('OBSERVAR DETALLES DEL REGISTRO') }}</b>
        </button>
      </h5>
    <div id="collapseArmado" class="collapse" data-parent="#armado">
      <div class="card-body">
        <div class="row">
